...
(function (global) {
    ...
    var T = {
        tr: {
            ...
            hero_kvkk_badge: 'KVKK Uyumlu Veri İşleme',
            ...
            hero_title_html: 'Çağrılarınızı Yöneten <span class="gradient-text">Yapay zeka asistanı</span>',
            hero_sub: 'Aspalo, gelen aramaları 7/24 yanıtlayan, randevu alan ve soruları cevaplayan bir yapay zeka asistanı. Hiçbir çağrı cevapsız kalmaz.',
            hero_cta_demo: 'Ücretsiz Demo Başlat',
            hero_cta_listen: 'Hemen Aspalo\'yu Dene',
            ...
            phone_ctrl_mute: 'Sessiz',
            phone_ctrl_end: 'Kapat',
            phone_ctrl_speaker: 'Hoparlör',
            ...
            cmp_title_html: 'İnsan mı, <span class="gradient-text">Aspalo mu?</span>',
            ...
            trust_desc: 'KVKK ve GDPR\'a sonradan eklenmiş değil, altyapının temelinde var olan uyum.',
            ...
            ref_title: 'Bize Güvenen Şirketler',
            ref_desc: 'Sağlık, turizm ve kurumsal hizmet sektörlerinden lider işletmeler Aspalo ile çalışıyor.',
            calc_title_html: 'Kaçırılan çağrı = <span class="gradient-text calc-loss-text">kaybedilen gelir</span>',
            calc_desc: 'İşletmenizin yılda ne kadar kaybettiğini hesaplayın. Sektörünüzü seçin, rakamları girin — sonuç sizi şaşırtabilir.',
            calc_pick_sector: 'Sektörünüzü seçin',
            calc_calls_label: 'Günlük kaçırılan çağrı sayısı',
            calc_value_label: 'Ortalama işlem / randevu değeri',
            calc_conv_label: 'Çağrıdan müşteriye dönüşüm oranı',
            calc_result_label: 'Tahmini yıllık kayıp',
            calc_b_daily: 'Günlük kayıp',
            calc_b_monthly: 'Aylık kayıp',
            calc_b_missed: 'Yıllık kaçan fırsat',
            calc_insight_default: 'Sektörünüzü seçin ve değerleri girin.',
            calc_cta_title: 'Bu kaybı sıfırlamak ister misiniz?',
            calc_cta_sub: 'Aspalo AI — 7/24 Türkçe sesli asistan. Ücretsiz demo alın.',
            calc_promo_cta: 'Ücretsiz Demo Al',
            plans_badge: 'Planlar',
            ...
            plan_per_month: '/ay',
            plan_vat_note: '+KDV',
            plan_p_minutes: 'İhtiyacınıza göre dakika paketi',
            plan_contact: 'Özel teklif',
            plan_cta: 'Bizimle iletişime geç',
            plan_cta_pro: 'Satış ekibiyle görüş',
            plan_popular: 'En Popüler',
            plan_plus: 'Basic\'teki her şey dahil, üstüne:',
            plan_b1: '1.000 dakika görüşme dahil', plan_b2: 'Gelen aramaları AI karşılar, cevaplar', plan_b3: 'Her görüşme kayda alınır, yazıya dökülür', plan_b4: 'Randevu alma ve yönetme', plan_b5: 'Anlık performans paneli',
            plan_g1: '2.000 dakika görüşme dahil', plan_g2: 'Giden aramalar da yapılır (hatırlatma, takip)', plan_g3: 'Aramalar önem sırasına göre otomatik sıralanır', plan_g4: 'Mevcut CRM sisteminizle entegre çalışır', plan_g5: 'WhatsApp üzerinden otomatik takip mesajı', plan_g6: 'Detaylı, kırılımlı performans raporları',
            plan_p1: 'Size özel dakika paketleri', plan_p2: 'Birden fazla asistanı farklı görevlere yönlendirme', plan_p3: 'İşletmenize özel akış ve senaryo tasarımı', plan_p4: 'Kendi sistemlerinize API ile bağlanma', plan_p5: 'Öncelikli, özel destek hattı',
        ...
        en: {
            ...
            hero_kvkk_badge: 'KVKK-Compliant Data Processing',
            ...
            hero_title_html: 'The <span class="gradient-text">AI Assistant</span> Managing Your Calls',
            hero_sub: 'Aspalo is an AI assistant that answers incoming calls 24/7, books appointments, and answers questions. No call goes unanswered.',
            hero_cta_demo: 'Start Free Demo',
            hero_cta_listen: 'Try Aspalo Now',
            ...
            phone_ctrl_mute: 'Mute',
            phone_ctrl_end: 'End',
            phone_ctrl_speaker: 'Speaker',
            ...
            trust_desc: 'Not bolted on after the fact — KVKK and GDPR compliance is built into the foundation.',
            ...
            calc_title_html: 'A missed call = <span class="gradient-text calc-loss-text">lost revenue</span>',
            calc_desc: 'Calculate how much your business loses every year. Pick your industry, enter your numbers — the result might surprise you.',
            calc_pick_sector: 'Pick your industry',
            calc_calls_label: 'Missed calls per day',
            calc_value_label: 'Average deal / appointment value',
            calc_conv_label: 'Call-to-customer conversion rate',
            calc_result_label: 'Estimated annual loss',
            calc_b_daily: 'Daily loss',
            calc_b_monthly: 'Monthly loss',
            calc_b_missed: 'Missed opportunities / year',
            calc_insight_default: 'Pick your industry and enter your numbers.',
            calc_cta_title: 'Want to eliminate this loss?',
            calc_cta_sub: 'Aspalo AI — 24/7 Turkish voice assistant. Get a free demo.',
            calc_promo_cta: 'Get a Free Demo',
            plans_badge: 'Plans',
            ...
            plan_per_month: '/mo',
            plan_vat_note: '+VAT',
            plan_p_minutes: 'Custom minute package based on your needs',
            plan_contact: 'Custom quote',
            plan_cta: 'Contact us',
            plan_cta_pro: 'Talk to sales',
            plan_popular: 'Most Popular',
            plan_plus: 'Everything in Basic, plus:',
            plan_b1: '1,000 minutes of calls included', plan_b2: 'AI answers and handles inbound calls', plan_b3: 'Every call is recorded and transcribed', plan_b4: 'Appointment booking and management', plan_b5: 'Real-time performance dashboard',
            plan_g1: '2,000 minutes of calls included', plan_g2: 'Outbound calls too (reminders, follow-up)', plan_g3: 'Calls are automatically prioritized', plan_g4: 'Works with your existing CRM', plan_g5: 'Automatic WhatsApp follow-up messages', plan_g6: 'Detailed, segmented performance reports',
            plan_p1: 'Custom minute packages for your needs', plan_p2: 'Route multiple assistants to different tasks', plan_p3: 'Custom flow and scenario design for your business', plan_p4: 'Connect to your own systems via API', plan_p5: 'Priority, dedicated support line',
